...
@et_40.ar_cmd(pattern="وقت(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await edit_delete(
            event,
...
async def variable(event):
    ...
    if input_str == "1":
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/Paskowy.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/Cream Cake.otf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/Hello Valentina.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/Alien-Encounters-Regular.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/Linebeam.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "et_40/helpers/styles/EASPORTS15.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
