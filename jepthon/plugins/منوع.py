...
@et_40.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@et_40.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** قناة السورس **⪼ [𐇮 جيبثون العربي ](t.me/et_40)   "
]

@et_40.on(admin_cmd(pattern="بلي$"))
...
@et_40.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@et_40.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(et_40_5erok))

    
@et_40.on(admin_cmd(pattern="اذكار عشر$"))    
...
@et_40.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@et_40.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
