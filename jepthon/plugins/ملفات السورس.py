...
@et_40.ar_cmd(
    ...
    info={
        "header": "To list all plugins in et_40.",
        "usage": "{tr}plugins",
    },
)
async def _(event):
    "To list all plugins in et_40"
    cmd = "ls et_40/plugins"
...
@et_40.ar_cmd(
    ...
    info={
        "header": "To list all environment values in et_40.",
        "description": "to show all heroku vars/Config values in your et_40",
        "usage": "{tr}env",
    },
)
async def _(event):
    "To show all config values in et_40"
    cmd = "env"
    o = (await _catutils.runcmd(cmd))[0]
    OUTPUT = (
